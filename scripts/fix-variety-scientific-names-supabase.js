#!/usr/bin/env node
/**
 * Fix botanical variety scientific names in Supabase to the convention:
 * "Genus species var. epithet" (full species, epithet lowercase).
 * e.g. "Ananas comosus var. microstachys" not "Ananas var. microstachys" or "Ananas comosus var. Microstachys".
 *
 * Usage: node scripts/fix-variety-scientific-names-supabase.js [--dry-run]
 */
...
async function main() {
  ...
  for (const row of rows) {
    ...
    const corrected = formatVarietyScientificName(plant);
