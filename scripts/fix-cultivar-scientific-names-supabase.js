#!/usr/bin/env node
/**
 * Fix cultivar scientific names in Supabase to the convention:
 * Full species name followed by 'Cultivar Name', e.g. "Aglaonema commutatum 'Red Ruby'".
 *
 * Usage: node scripts/fix-cultivar-scientific-names-supabase.js [--dry-run]
 */
...
async function main() {
  ...
  for (const row of rows) {
    ...
    const corrected = formatCultivarScientificName(plant);
