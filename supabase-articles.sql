...
(
  70006,
  'life-inside-a-terrarium',
  $article70006$
{
  "id": 70006,
  "slug": "life-inside-a-terrarium",
  "title": "Beyond Soil and Plants: What Really Lives in a Terrarium",
  "excerpt": "Springtails, mushrooms, algae, and invisible microbes—healthy terrariums are small ecosystems. Here is what may appear besides the plants you chose, and what is normal.",
  "category": "Guides",
  "publishedAt": "2026-08-07",
  "readMinutes": 8,
  "coverImage": null,
  "hidden": false,
  "bodyHtml": "<p>Many people picture a terrarium as a neat jar of soil and pretty leaves—a miniature garden sealed behind glass. That image is not wrong, but it is incomplete. A healthy terrarium is a small ecosystem. Alongside the plants you chose on purpose, other living things often appear: tiny arthropods, fungi, bacteria, and algae. Most are normal. Some are even desirable. Understanding what they are—and what they do—helps you enjoy the enclosure instead of worrying about every speck you see.</p><h2>The cleaning crew: nature's maintenance team</h2><p>In bioactive and closed setups, keepers deliberately add—or soon discover—microfauna that break down organic waste. These cleanup crews recycle dead leaves, dropped petals, and leftover organic matter before mold takes over.</p><ul><li><strong>Springtails</strong> — Pinhead-sized white or gray jumpers that thrive in moist substrate. They eat decaying matter and fungal spores.</li><li><strong>Isopods</strong> — Small roly-polies that graze on leaf litter and soft debris. Different species suit tropical versus temperate humidity.</li><li><strong>Other detritivores</strong> — Millipedes, certain worms, and small beetles may appear in larger vivariums. They play the same recycling role at a slightly larger scale.</li></ul><p>Seeing a few springtails on the glass or after watering is usually a good sign, not an infestation.</p><h2>Mushrooms and other fungi</h2><p>Fungi are everywhere—in potting mixes, on bark, and floating as invisible spores in the air. When humidity and warmth align, mushrooms or fuzzy patches can pop up overnight. That can startle owners who expected only green plants.</p><p>Many mushroom fruiting bodies are harmless to healthy plants and fade once conditions shift. Persistent gray or white mold on living leaves, however, signals excess moisture, poor airflow, or decay that should be removed. Brief ventilation and trimming affected material usually resolves the issue in closed jars.</p><h2>Microbes beneath the surface</h2><p>Bioactive substrate is not sterile dirt. Bacteria and fungi form a living web that helps break down waste, cycle nutrients, and keep roots healthy—similar to soil outdoors. Activated charcoal and drainage layers manage excess moisture; the microbial layer handles the rest over time.</p><p>This is why experienced builders avoid drenching a new terrarium with fungicides or boiling every component. You would remove the helpers along with the problems.</p><h2>Algae, biofilm, and glass stains</h2><p>Green or brown film on glass, hardscape, or the water feature in a paludarium is algae or bacterial biofilm. It appears when light and nutrients are available—especially near windows or strong grow lights.</p><ul><li>Light algae on glass: wipe during maintenance or reduce light slightly</li><li>Slime on driftwood or stones: common in humid setups; usually cosmetic</li><li>Thick green mats on soil: often too much light or over-fertilizing—adjust before it smothers small plants</li></ul><h2>Guests you did not order</h2><p>Even carefully built terrariums occasionally host uninvited visitors:</p><ul><li><strong>Fungus gnats</strong> — Small flies whose larvae live in damp soil. Usually harmless in small numbers; dry the surface slightly or add springtails to compete.</li><li><strong>Nematodes and micro-worms</strong> — Invisible or barely visible; often part of healthy soil food webs.</li><li><strong>Snails or mites</strong> — Can hitchhike on plants or moss. Remove individuals if they eat prized foliage; otherwise monitor population size.</li></ul><p>In animal vivariums, additional species may be intentional—fruit flies as feeders, for example—but plant-only terrariums rarely need any of these.</p><h2>Normal versus worth acting on</h2><p>Use this quick guide when something new appears:</p><ul><li><strong>Usually fine:</strong> a few springtails, one short-lived mushroom, light glass algae, leaf litter slowly disappearing</li><li><strong>Investigate:</strong> soft mushy stems, leaves coated in thick mold, sour smell, plants declining despite good light</li><li><strong>Act soon:</strong> rapid pest explosion, animal distress in a vivarium, standing water with anaerobic smell</li></ul><h2>What to expect from a living terrarium</h2><p>Well-built terrariums and bioactive kits are designed around living systems—not plastic-perfect dioramas. You may see evidence of a healthy cleanup crew, seasonal fungal fruiting, or a faint biofilm after setup. That is ecology working as intended. The goal is to balance humidity, light, and maintenance for indoor conditions—not to sterilize the glass.</p><p>If you prefer a cleaner, minimal look, open terrariums with fewer organic inputs stay visually simpler—but even then, microscopic life is part of the story. Knowing that upfront turns &ldquo;what is that?&rdquo; into &ldquo;oh, that is the terrarium doing its job.&rdquo;</p>"
}
$article70006$::jsonb
)
